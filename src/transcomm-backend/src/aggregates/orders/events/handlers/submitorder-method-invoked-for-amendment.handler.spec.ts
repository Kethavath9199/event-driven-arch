...
describe('Submit Order Method Invoked For Amendment Event Handler', () => {
  let eventHandler: SubmitOrderMethodInvokedForAmendmentEventHandler;
  ...
  beforeEach(async () => {
    ...
    eventHandler =
      module.get<SubmitOrderMethodInvokedForAmendmentEventHandler>(
        SubmitOrderMethodInvokedForAmendmentEventHandler,
      );
  ...
  it('should create chain event', async () => {
    ...
    const request = new SubmitOrderMethodInvokedForAmendmentEvent(
      'test',
      'test',
      'test',
      'test',
