...
import { ReturnUpdateTransportInfoMethodInvokedEvent } from "../impl/return-updatetransportinfo-method-invoked.event";
import { closeManualRetryView } from "./helpers/update-manualRetryView";

@EventsHandler(ReturnUpdateTransportInfoMethodInvokedEvent)
export class ReturnUpdateTransportInfoMethodInvokedHandler
    implements IEventHandler<ReturnUpdateTransportInfoMethodInvokedEvent>
{
    ...
    async handle(event: ReturnUpdateTransportInfoMethodInvokedEvent): Promise<void> {
