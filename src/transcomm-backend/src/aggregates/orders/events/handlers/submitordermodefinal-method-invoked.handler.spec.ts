...
describe('Submit OrderMode Final Method Invoked Handler', () => {
    let eventHandler: SubmitOrderModeFinalMethodInvokedHandler;
    ...
    beforeEach(async () => {
        ...
        eventHandler =
            module.get<SubmitOrderModeFinalMethodInvokedHandler>(
                SubmitOrderModeFinalMethodInvokedHandler,
            );
    ...
    it('should create chain event', async () => {
        ...
        const request = new SubmitOrderModeFinalMethodInvokedEvent(
            'test',
            'test',
            'test',
            'test',
