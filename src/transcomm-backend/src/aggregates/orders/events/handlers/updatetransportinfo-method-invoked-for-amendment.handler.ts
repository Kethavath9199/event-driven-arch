...
@EventsHandler(UpdateTransportInfoMethodInvokedForAmendmentEvent)
export class UpdateTransportInfoMethodInvokedForAmendmentHandler
  implements IEventHandler<UpdateTransportInfoMethodInvokedForAmendmentEvent>
{
  constructor(
  ...
  async handle(
    event: UpdateTransportInfoMethodInvokedForAmendmentEvent,
  ): Promise<void> {
