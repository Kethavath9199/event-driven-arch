...
import { SubmitCancelOrderMethodInvokedHandler } from './submitcancelorder-method-invoked.handler';
...
describe('Submit OrderMode Final Method Invoked Handler', () => {
    let eventHandler: SubmitCancelOrderMethodInvokedHandler;
    ...
    beforeEach(async () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                SubmitCancelOrderMethodInvokedHandler,
                {
        ...
        eventHandler =
            module.get<SubmitCancelOrderMethodInvokedHandler>(
                SubmitCancelOrderMethodInvokedHandler,
            );
    ...
    it('should create chain event', async () => {
        ...
        const request = new SubmitCancelOrderMethodInvokedEvent(
            'test',
            'test',
            'test',
            'test',
